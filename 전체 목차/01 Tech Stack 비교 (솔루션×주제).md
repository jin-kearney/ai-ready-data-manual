...
>
> **반영(reflect-back) 규칙:** 20개 주제 가이드를 작성하며 **새로 조사된 솔루션은 반드시 이 문서 Part A의 해당 주제 표에 추가**하고, 새 플랫폼이면 Part B 매트릭스 행도 갱신한다. 즉 가이드는 기능을 비교하고, 정본은 그 결과를 누적해 묶음 평가를 가능하게 한다. (작성 절차: `ai-ready-manual-guide` 스킬 / 표준: `공통 규칙/01 가이드 작성 표준.md`)
>
