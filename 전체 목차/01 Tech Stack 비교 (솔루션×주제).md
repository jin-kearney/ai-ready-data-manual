...
> **제안용 요약본:** RFP 5개 영역(수집·전처리 / 메타·카탈로그·글로서리 / 어노테이션·온톨로지 / 품질·계보·감사 / AI·RAG·Agent 연계)으로 좁힌 제안 Tech Stack은 [02 제안 Tech Stack (RFP 5개 영역)](02%20제안%20Tech%20Stack%20(RFP%205개%20영역).md)에 별도로 둔다. 이 문서(01)는 20개 주제 전체를 다루는 정본이다.
> **읽는 법(2층 구조):**
