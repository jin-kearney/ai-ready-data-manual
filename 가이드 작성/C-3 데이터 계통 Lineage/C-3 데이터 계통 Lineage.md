...
| KPI | 정의 | 산식 | 활용 목적 |
|------|------|------|-----------|
| Lineage Coverage | 관리 대상 데이터 중 Lineage가 구축된 비율 | 구축 대상 자산 중 Lineage 연결 완료 비율 | 구축 범위 관리 |
...
| KPI | 정의 | 산식 | 활용 목적 |
|------|------|------|-----------|
| Broken Lineage 비율 | 단절된 계통 비율 | 단절 Edge / 전체 Edge | 계통 품질 관리 |
| 잘못된 Lineage 수정 Lead Time | 오류 발견 후 수정 완료까지 소요시간 | 평균 수정시간 | 운영 효율성 |
