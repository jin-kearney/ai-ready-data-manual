...
<!-- KQ→섹션 매핑(자가 점검): KQ1 대상 흐름→2.2(s22)+3(when) / KQ2 변환 기록→2.3(s23)+4.4(s44) / KQ3 근거 역추적→2.3(s23)+4.1(s41)+4.4(s44) / KQ4 변경 영향→2.4(s24)+4.3(s43) / KQ5 감사 증빙→2.4(s24)+3.2(s32) / KQ6 KPI→7(kpi), 공통 운영 기준→별첨 C. -->
