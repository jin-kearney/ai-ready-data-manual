...
2. [What — 무엇을 갖추나 (용어 카드·동의어·유형)](#2-what--무엇을-갖추나-용어-카드동의어유형)
   - [2.1 비즈니스 Glossary란 + 체계 내 위치](#21-비즈니스-glossary란--체계-내-위치)
   - [2.2 표준 용어 카드 — 표준 정의 항목](#22-표준-용어-카드--표준-정의-항목)
   - [2.3 동의어·금지어](#23-동의어금지어-현장-표현을-표준어로-잇기)
   - [2.4 연계 정보](#24-연계-정보-데이터-필드책임-부서)
   - [2.5 두 가지 유형 — 비즈니스 용어 / 지표 기준](#25-두-가지-유형--비즈니스-용어--지표-기준)

3. [When — 어디부터 표준화하나 (우선순위)](#3-when--어디부터-표준화하나-우선순위)
   - [3.1 표준화 대상 용어](#31-표준화-대상-용어)
   - [3.2 우선순위](#32-우선순위)
   - [3.3 표준화 대상 선정 기준](#33-표준화-대상-선정-기준)
...
**ii) 등록 및 게시** ① 소량은 UI에서 직접 입력, ② **대량은 엑셀/CSV로 모아 일괄 import**(현업이 익숙한 방식 — 엑셀로 작성 → 검수 → 업로드), ③ 자동화는 API로 등록. 업로드 후 검수·승인(§6.1 iii)을 거쳐 "게시"된다.
