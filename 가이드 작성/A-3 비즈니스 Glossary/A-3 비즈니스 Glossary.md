...
4. [How — 어떻게 준비·운영하나](#4-how--어떻게-준비운영하나)
   - [4.1 표준 용어 정의 절차](#41-표준-용어-정의-절차)
   - [4.2 용어 충돌 조정](#42-용어-충돌-조정)
   - [4.3 표준 용어 저장소와 활용 체계](#43-표준-용어-저장소와-활용-체계)
   - [4.4 동의어 및 약어 관리](#44-동의어-및-약어-관리)
   - [4.5 용어 변경 관리](#45-용어-변경-관리)
...
| 단계 | 주요 활동 | 산출물 | 관련 절 |
|---|---|---|---|
| ① 용어 수집 | QMS 결함 코드, 작업일지, 품질 보고서에서 실제 사용 표현 수집 | 현장 용어 목록 | §4.1 |
| ② 용어 정리 및 합의 | 품질 SME가 동의어와 표준명 정의 | 표준명 후보 및 동의어 그룹 | §4.1 |
| ③ 용어 카드 작성 | 정의, 동의어, 금지어, 책임 부서, 관련 필드 등록 | 용어 카드 | §4.1, Appendix A |
| ④ 충돌 조정 | 의미가 중복되거나 불명확한 용어 정리 | 승인된 표준 정의 | §4.2 |
| ⑤ 등록 및 게시 | 표준 용어를 Glossary에 등록하고 검수 | 표준 용어집 | §4.3 |
| ⑥ 전사 공유 | 카탈로그, QMS, 검색 서비스에 반영 | 공통 용어 체계 적용 | §4.3 |
| ⑦ 검색 연계 | 동의어와 약어를 표준 용어에 연결 | 검색·AI 활용 체계 반영 | §4.4 |
| ⑧ 운영 및 유지보수 | 신규 용어 등록 및 변경 관리 | 최신 Glossary 유지 | §4.5 |
...
**ii) 등록 및 게시** ① 소량은 UI에서 직접 입력, ② **대량은 엑셀/CSV로 모아 일괄 import**(엑셀로 작성 → 검수 → 업로드), ③ 자동화는 API로 등록. 업로드 후 검수·승인(§4.1 iii)을 거쳐 "게시"된다.
