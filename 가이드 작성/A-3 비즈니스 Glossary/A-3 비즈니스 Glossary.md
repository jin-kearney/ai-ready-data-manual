...
**i) 표준 용어 저장소** 용어는 *딱 한 곳*에만 정본을 둔다. 부서마다 엑셀을 따로 두면 표준화의 의미가 없다.
...
> 용어 정의 변경은 보고서, 메타데이터, 검색 결과, AI 서비스의 해석 기준에 영향을 줄 수 있으므로 변경 전 영향도를 검토하는 것이 필요하다. — "확정 매출"의 정의가 바뀌면 그 용어를 인용한 모든 메타·Prompt가 영향받으므로, 변경 영향 점검이 필수다.
