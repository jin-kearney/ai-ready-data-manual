...
**👉 한 줄 요약:** 날짜표가 아니라 **수준**으로 본다. **"용어가 얼마나 표준화·연계되고, 후보 발굴을 AI가 얼마나 돕는가"** 기준으로, 「지금 우리가 이런 모습이면 = 이 수준」을 짚고 → 「다음 단계로 가려면 무엇을」 정한다.
...
**👉 한 줄 요약:** 용어 준비 중 *후보를 찾고 매핑하는 일*은 갈수록 AI가 대신하고, *정의를 확정하고 합의·승인하는 판단*은 사람이 끝까지 쥔다.
