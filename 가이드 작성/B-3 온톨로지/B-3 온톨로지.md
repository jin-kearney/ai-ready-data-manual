...
- **1단계 — 범위 정의:** 이 온톨로지가 답해야 할 질문은 무엇인가? 도메인(예: "라인3 제품군 용접 결함")·대상 사용자·**경쟁 질문(CQ, Competency Questions)**을 정의한다. CQ는 7단계의 합격 테스트가 된다. 🏭 예: "이번 분기 라인3 박리 결함의 상위 원인은?", "스크래치 발생과 관련된 공정 파라미터는?", "지난 12개월 접합불량에 적용된 조치는?"
...
| **핵심 질문 역검증** | 1단계 목적 관점의 질문 3~5개(CQ)로 "지금 설계가 이 질문에 답하나" 되짚음 | 1·7단계 | 설계가 목적에서 벗어났는지 조기 발견 |
