...
**본문 가이드(일반론)**는 온톨로지가 무엇이고 어떤 구성요소로 어떤 9단계 절차로 만드는가를 다룬다. 그 절차를 밟다 보면 **노드 하나, 관계 하나를 둘지·어디에 붙일지**를 매번 판단해야 하는데, **이 문서(각론)**가 바로 그 **판단 기준**이다. 일반론이 "무엇을 해야 하나"라면, 각론은 "이 결정을 무슨 기준으로 내리나"에 답한다.
...
> 일반론을 모르면 먼저 [메인 가이드 `B-3 온톨로지.md`](../B-3%20온톨로지.md)를 본다.
...
- 일반론: [메인 가이드 `B-3 온톨로지.md`](../B-3%20온톨로지.md) — 개념·구성요소·9단계 절차
