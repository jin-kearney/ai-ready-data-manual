...
품질 관리를 지속적으로 운영하기 위해 아래를 정의한다.

| 운영 기준 | 무엇을 지키나 |
|------|-------------|
| 품질 규칙 | AI 활용 대상 데이터에 품질 규칙과 합격선을 정의한다 |
| Quality Gate | AI 학습·추론 전 Quality Gate를 적용하고, 통과하지 못한 데이터는 활용에서 제외한다 |
| 데이터 오너십 | 품질 관리 대상마다 품질을 책임지는 데이터 오너를 지정한다 |
| 역할·책임(R&R) | 품질 규칙 정의·검증·예외 승인의 역할과 책임을 구분한다 |
| 생애주기(Lifecycle) | 데이터 생성부터 폐기까지 단계별 품질 관리 기준을 정의한다 |
