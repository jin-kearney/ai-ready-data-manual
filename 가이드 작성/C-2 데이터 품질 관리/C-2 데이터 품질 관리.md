...
| 품질 관리를 어떻게 측정하나 | Quality Gate 적용률·통과율·품질 이슈 발생률로 점검한다(공통 운영 기준은 별첨 C) | [7](#kq5) |
...
운영 기준(데이터 오너십·역할과 책임·생애주기)은 신뢰성 세 주제가 공유하므로 [별첨 C. 운영 기준서](../별첨%20C%20운영%20기준서/별첨%20C.%20운영%20기준서.md)에 공통으로 정의한다. 이 절은 품질 관리가 잘 되고 있는지 보는 KPI만 다룬다.
