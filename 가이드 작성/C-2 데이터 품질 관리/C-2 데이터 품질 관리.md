...
<!-- KQ→섹션 매핑(자가 점검): KQ1 AI 활용을 위한 데이터 품질 기준→2.2(s22)+2.3(s23) / KQ2 AI 사용 제한 데이터→2.4(s24)+3(when) / KQ3 Quality Gate→4.2(s42)+4.3(s43)+4.4(s44) / KQ4 품질 관리 측정→7.1(s71)+7.2(s72). -->
---
...
운영 과정에서는 품질 규칙 적용 범위, Quality Gate 운영 수준, 품질 개선 현황을 지속적으로 점검하고 관리한다.

운영 수준을 평가하기 위한 상세 KPI와 성숙도 기준은 **7장 KPI**에서 정의한다.
