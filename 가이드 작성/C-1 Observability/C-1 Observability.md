...
> 핵심 질문 1 — "어떤 데이터 이상을 관찰해야 하는가"에 답하는 절.
...
> 핵심 질문 2 — "이상 여부를 어떤 기준으로 판단할 것인가"에 답하는 절.
...
> 핵심 질문 3 — "이상이 발생했을 때 누구에게 어떻게 알릴 것인가"에 답하는 절.
...
> 핵심 질문 4 — "AI 결과 이상이 데이터 문제인지 모델 문제인지 어떻게 구분할 것인가"에 답하는 절.
...
> **2층 연결:** 솔루션을 주제 가로질러 묶어 평가·선정하려면 → [Tech Stack 비교 정본](../../전체%20목차/01%20Tech%20Stack%20비교%20(솔루션×주제).md). 본 절은 데이터 관측 관점에서 솔루션의 기능을 비교한다.
...
> 핵심 질문 5 — "Observability 운영 수준을 어떻게 측정할 것인가"에 답하는 절.
