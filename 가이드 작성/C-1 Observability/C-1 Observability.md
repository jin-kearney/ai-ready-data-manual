...
| Observability 운영 수준을 어떻게 측정할 것인가? | 관측 커버리지·이상 감지 시간(MTTD)·오탐률로 점검한다(공통 운영 기준은 별첨 C) | [7](#kq5) |
...
운영 기준(데이터 오너십·역할과 책임·생애주기)은 신뢰성 세 주제가 공유하므로 [별첨 C. 운영 기준서](../별첨%20C%20운영%20기준서/별첨%20C.%20운영%20기준서.md)에 공통으로 정의한다. 이 절은 관측이 잘 되고 있는지 보는 KPI만 다룬다.
