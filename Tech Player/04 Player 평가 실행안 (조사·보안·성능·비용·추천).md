...
- [1. 한 장으로 보는 전체 흐름](#s1)
- [2. 1단계 — Player 전수 조사 (14개 카테고리)](#s2)
...
<a id="s2"></a>
## 2. 1단계 — Player 전수 조사 (14개 카테고리)

[03](03%20제안%20솔루션%20구성%20(영역별%20솔루션%20단위).md)이 묶은 **14개 솔루션 카테고리**가 조사 단위다. 카테고리마다 대표 Player 5개 내외를 모은다(03 §3에 이미 후보 표가 있다 — 이 패스가 그 빈 점수 칸을 채운다).
